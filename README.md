...
```bash
bash <(curl -s https://raw.githubusercontent.com/sarve/nvim/main/utils/installer/install.sh)
```
or 

```powershell
iwr https://raw.githubusercontent.com/sarvex/nil/main/utils/installer/install.ps1 -UseBasicParsing | iex
```


for more info go to https://nil.org
## Config
the user config for nil is located art `~/.config/nil/config.lua` nearly every thing is configurable
...
![nil](https://user-images.githubusercontent.com/94284073/184992722-dc07f4c6-22d0-4250-aa62-38119a2b506c.png)
