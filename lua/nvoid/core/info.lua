...
local text = require "nil.interface.text"
local lsp_utils = require "nil.lsp.utils"
...
local function make_formatters_info(ft)
  local null_formatters = require "nil.lsp.null-ls.formatters"
...
local function make_code_actions_info(ft)
  local null_actions = require "nil.lsp.null-ls.code_actions"
...
local function make_linters_info(ft)
  local null_linters = require "nil.lsp.null-ls.linters"
