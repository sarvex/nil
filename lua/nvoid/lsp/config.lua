...
local join_paths = require("nil.utils").join_paths
...
return {
  ...
  buffer_mappings = {
    normal_mode = {
      ...
      ["gp"] = {
        function()
          require("nil.lsp.peek").Peek "definition"
        end,
        "Peek definition",
      },
      ["gl"] = {
        function()
          local config = nil.lsp.diagnostics.float
          config.scope = "line"
  ...
  ---@deprecated use nil.lsp.automatic_configuration.skipped_servers instead
  override = {},
  ---@deprecated use nil.lsp.installer.setup.automatic_installation instead
