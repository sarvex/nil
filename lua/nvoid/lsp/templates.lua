...
local nil_lsp_utils = require "nil.lsp.utils"

local ftplugin_dir = nil.lsp.templates_dir
...
local skipped_filetypes = nil.lsp.automatic_configuration.skipped_filetypes
local skipped_servers = nil.lsp.automatic_configuration.skipped_servers
local ensure_installed_servers = nil.lsp.installer.setup.ensure_installed
...
function M.generate_ftplugin(server_name, dir)
  ...
  end, nil_lsp_utils.get_supported_filetypes(server_name) or {})
...
---The files are generated to a runtimepath: "$NIL_RUNTIME_DIR/site/after/ftplugin/template.lua"
---@param servers_names? table list of servers to be enabled. Will add all by default
function M.generate_templates(servers_names)
  servers_names = servers_names or nil_lsp_utils.get_supported_servers()
