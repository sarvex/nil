...
local modesN = {
  ["n"] = { "Nil", "St_NormalMode" },
  ["no"] = { "Nil", "St_NormalMode" },
  ["i"] = { "Nil", "St_InsertMode" },
  ["ic"] = { "Nil", "St_InsertMode" },
  ["t"] = { "Nil", "St_TerminalMode" },
  ["nt"] = { "Nil", "St_NTerminalMode" },
  ["v"] = { "Nil", "St_VisualMode" },
  ["V"] = { "Nil", "St_VisualMode" },
  [""] = { "Nil", "St_VisualMode" },
  ["R"] = { "Nil", "St_ReplaceMode" },
  ["Rv"] = { "Nil", "St_ReplaceMode" },
  ["s"] = { "Nil", "St_SelectMode" },
  ["S"] = { "Nil", "St_SelectMode" },
  [""] = { "Nil", "St_SelectMode" },
  ["c"] = { "Nil", "St_CommandMode" },
  ["cv"] = { "Nil", "St_CommandMode" },
  ["ce"] = { "Nil", "St_CommandMode" },
  ["r"] = { "Nil", "St_ConfirmMode" },
  ["rm"] = { "Nil", "St_ConfirmMode" },
  ["r?"] = { "Nil", "St_ConfirmMode" },
  ["!"] = { "Nil", "St_TerminalMode" },
}
