...
local function r_inspect_settings(structure, limit, separator)
  ...
  if type(structure) == "function" then
    ...
    io.write("-- nil", separator:sub(2), " = function ()\n")
  else
    io.write("nil", separator:sub(2), " = ", tostring(structure), "\n")
  end
  return limit - 1
end
...
function M.generate_settings()
  ...
  -- write all `nil` related settings to `lv-settings.lua` file
  r_inspect_settings(nil, 10000, ".")
