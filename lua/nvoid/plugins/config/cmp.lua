  ...
  nil.builtin.cmp = {
    ...
    formatting = {
      ...
      format = function(entry, vim_item)
        local max_width = nil.builtin.cmp.formatting.max_width
        if max_width ~= 0 and #vim_item.abbr > max_width then
          vim_item.abbr = string.sub(vim_item.abbr, 1, max_width - 1) .. icons.ui.Ellipsis
        end
        vim_item.kind = nil.builtin.cmp.formatting.kind_icons[vim_item.kind]
        ...
        vim_item.menu = nil.builtin.cmp.formatting.source_names[entry.source.name]
        vim_item.dup = nil.builtin.cmp.formatting.duplicates[entry.source.name]
            or nil.builtin.cmp.formatting.duplicates_default
        return vim_item
      end,
    },
    snippet = {
